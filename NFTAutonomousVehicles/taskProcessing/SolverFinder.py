...
class SolverFinder:
    ...
    def searchForProvider(self,  mapGrid, task, solver_collection_names)->TaskSolver:
        ...
        for solver in solvers_list:
            ...
            nft = solver.reserveSolvingCapacity(start_timestamp, end_timestamp, task.capacity_needed_to_solve,
                                                task.vehicle)
            if nft is not None:
