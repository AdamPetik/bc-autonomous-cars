...
class NFT:
    ...
    def __init__(self, owner: AutonomousVehicle, solver: TaskSolver, valid_from, valid_to, reserved_ips, single_transfer_time, transfer_rate, signed, reserved_rbs=0):
        uid = UniqueID()
        self.id = uid.getId()
    ...
    def toJson(self) ->str:
        ...
        output["reserved_ips"] = self.reserved_ips
